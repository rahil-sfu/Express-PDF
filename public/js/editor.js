...
function addPdfToList(name, url) {
  ...
  button.onclick = function () {
    ...
    // Note: Removing the file from globalDT for a specific file is non-trivial.
    // For a complete solution, consider maintaining your own file array.
  };
  ...
  // Show the "Edit PDF" submit button when at least one file is selected
